CREATE TABLE [bds].[TABLON_DIF] (
  ...
  CONSTRAINT [PK_TABLON_DIF] PRIMARY KEY CLUSTERED ([CODIGOPERSONA], [NUMTARJETABONUS], [CODIGODEPARTICIPANTE], [CODIGODELOCAL], [FECHATRANSACCION_CAB], [NROPOS], [NROTRNPOS], [IDTRX], [SEC])
)
ON [PRIMARY]
GO