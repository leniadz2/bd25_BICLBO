...
EXEC sys.sp_addextendedproperty N'MS_Description', N'cantidad de actualizaciones para un mismo cliente', 'SCHEMA', N'bds', 'TABLE', N'TABLON_old', 'COLUMN', N'CNT_C_A'
GO