CREATE TABLE [bds].[TABLON_PRE] (
  ...
  CONSTRAINT [PK_TABLON_PRE] PRIMARY KEY CLUSTERED ([CODIGOPERSONA], [NUMTARJETABONUS], [CODIGODEPARTICIPANTE], [CODIGODELOCAL], [FECHATRANSACCION_CAB], [NROPOS], [NROTRNPOS], [IDTRX], [SEC])
)
ON [PRIMARY]
GO