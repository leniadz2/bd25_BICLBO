CREATE TABLE [bds].[TRANSACCION] (
  ...
  [date] [varchar](8) NULL,
  [hora] [varchar](8) NULL,
  CONSTRAINT [PK_B_TRANSACCION] PRIMARY KEY CLUSTERED ([CODIGODEPARTICIPANTE], [CODIGODELOCAL], [NUMTARJETABONUS], [FECHATRANSACCION_CAB], [HORATRANSACCION_CAB], [NROPOS], [NROTRNPOS], [CODIGODEPROMOCION], [IDTRX], [SEC], [PLU])
)
ON [PRIMARY]
GO