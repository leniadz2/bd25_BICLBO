...
EXEC sys.sp_addextendedproperty N'MS_Description', N'cantidad de actualizaciones para un mismo cliente', 'SCHEMA', N'bds', 'TABLE', N'xTABLON_bkp', 'COLUMN', N'CNT_C_A'
GO