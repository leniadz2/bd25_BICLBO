CREATE TABLE [bds].[TABLON] (
  ...
  [CNT_C_A] [int] NULL,
  CONSTRAINT [PK_TABLON] PRIMARY KEY CLUSTERED ([CODIGOPERSONA], [NUMTARJETABONUS], [CODIGODEPARTICIPANTE], [CODIGODELOCAL], [FECHATRANSACCION_CAB], [NROPOS], [NROTRNPOS], [IDTRX], [SEC])
)
ON [PRIMARY]
GO

EXEC sys.sp_addextendedproperty N'MS_Description', N'cantidad de actualizaciones para un mismo cliente', 'SCHEMA', N'bds', 'TABLE', N'TABLON', 'COLUMN', N'CNT_C_A'
GO